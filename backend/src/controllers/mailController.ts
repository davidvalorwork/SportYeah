...
export class MailController
{
    ...
    public static verifyAccount(user:any,validationLink:string):void
    {
        ...
        Mail.send(
            ...
            console.info(`[OK] Mensaje ${result} enviado con éxito a ${user.email}`);
        }).catch(error => {
    ...
    public static verifyAccountParents(user:any,validationLink:string):void
    {
        ...
        Mail.send(
            ...
            console.info(`[OK] Mensaje ${result} enviado con éxito a ${user.parents_email}`);
        }).catch(error => {
            console.error(`[ERROR] ${error}`);
        });
    }
    ...
    public static contactUs(user:any):void
    {
        ...
        Mail.send(
            ...
            console.info(`[OK] Mensaje ${result} enviado con éxito a ${ Config.get('app.admin')}`);
        }).catch(error => {
            console.error(`[ERROR] ${error}`);
        }); 
