...
export class VolleyBall {
  ...
  juan: NodeStructure = new NodeStructure(
    [`https://images.unsplash.com/photo-1592656094267-764a45160876?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80`],
    [],
    `Juan`,
    `Entrenador`,
